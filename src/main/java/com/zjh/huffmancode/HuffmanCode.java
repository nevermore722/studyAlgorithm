...
public class HuffmanCode {
   ...
   * @return 返回赫夫曼编码处理后的byte[] 举例： String content = "i like like like java do you like a java";
   * =>byte[] contentBytes = content.getBytes(); 返回的是 字符串=>对应的byte[] huffmanCodes,即8位对应一个byte,放入到huffmanCodes中
   * huffmanCodes[0] = 10101000=>byte
   */
...
//    System.out.println("测试stringBuilder=" + stringBuilder.toString());
    //将"1010100010111111110010001011111111..."转成byte[]
